        ...
        <div class="col-11 col-sm-10 col-md-10 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                ...
                <form id="msform">
                    <!-- progressbar -->
                    <ul id="progressbar">
                        <li class="active" id="account"><strong>PERSONAL DATA</strong></li>
                        <li id="personal"><strong>WORKING POSITION</strong></li>
                        <li id="payment"><strong>COMPANY</strong></li>
                        <li id="confirm"><strong>Login data</strong></li>
                    </ul>
                    <div class="progress">
        	...
        	<div class="col-11 col-sm-10 col-md-10 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
            	<div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                	...
                	<?php if(!is_checkout()){ ?>
         				...
         				<?php }
         				do_action( 'woocommerce_register_form_start' );  do_action( 'woocommerce_register_form' ); ?>
         					<ul id="progressbar">
		                        <li class="active" id="account"><strong>PERSONAL DATA</strong></li>
		                        <li id="personal"><strong>WORKING POSITION</strong></li>
		                        <li id="payment"><strong>COMPANY</strong></li>
		                    ...
		                    <fieldset>
		                        <div class="form-card">
		                            <div class="row">
		                                <div class="col-7">
		                                    <h2 class="fs-title">WORKING POSITION:</h2>
		                                </div>
		                                <div class="col-5">
		                                    <h2 class="steps">Step 2 - 4</h2>
		                                </div>
		                    ...
		                    <fieldset>
		                        <div class="form-card">
		                            <div class="row">
		                                <div class="col-7">
		                                    <h2 class="fs-title">Comapny Data:</h2>
		                                </div>
		                                <div class="col-5">
		                                    <h2 class="steps">Step 3 - 4</h2>
		                                </div>
		                            </div>
		                            <div class="new-company-register hide">
				                        <div class="company-data cstm-row">
				                           <p>
				                                 <label for="business_name">Business Name</label>
				                                 <input type="text" id="business_name" name="business_name" class="required-field">
