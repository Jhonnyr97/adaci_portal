...
add_shortcode( 'leran_dash_short_registration', 'adaci_course_short_registration_multistep_form' );
   
   function adaci_course_short_registration_multistep_form() {
      if(!is_checkout()){ 
         if ( is_admin() ) return;
        ...
        <div class="row justify-content-center">
                ...
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                        ...
                        <?php if(!is_checkout()){ ?>
                                    ...
                                    <input type="hidden" name="registration_type" value="short-registration">
